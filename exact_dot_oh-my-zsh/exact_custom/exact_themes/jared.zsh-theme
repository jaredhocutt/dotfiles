# This theme is a modified version of the ys theme.
...
# Prompt format:
#
# USER at MACHINE in DIRECTORY on git:BRANCH STATE C:LAST_EXIT_CODE
# ❯ COMMAND
#
# For example:
#
# jared at jared-mac in ~/.local/share/chezmoi on git:main x
PROMPT="
%(#,%{$bg[yellow]%}%{$fg[black]%}%n%{$reset_color%},%{$fg[cyan]%}%n) \
%{$reset_color%}at \
%{$fg[green]%}$(cat ~/.box-name) \
%{$reset_color%}in \
